            ...
            <div className="relative inline-block">
              ...
              {showDropdown && (
                <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded shadow-lg z-10">
                  <Link to="/admin"><a href="/admin-login" className="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 transition">Admin Login</a></Link>
                  <Link to="/user"><a href="/employee-login" className="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 transition">Employee Login</a></Link>
                </div>
              )}
            </div>
